...
<%@page import="com.dts.ManagePrison.dao.CriminalCaseRegisterDao"%><!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">
<html>
<head>
...
<span id="clock"></span>
    ...
    <center><h1><font color="#FFFF00"></font></h1></center>
         <form action="updateCrimnalCaseRegisterDetails.do" name="register">
         <table bgcolor="#8DD79C">
         <tr bgcolor="#0E5519">
         <% CriminalCaseRegisterForm aform=new CriminalCaseRegisterDao().ViewCriminalCaseRegisterById(request.getParameter("criminalname"));
        ...
        String policestationname=aform.getPoliceStationName();
        ...
        String inspectorname=aform.getInspectorName(); %>
         ...
         <tr><td><b>Criminal Name</b></td><td><input type="text" name="criminalname" value="<%=request.getParameter("criminalname") %>" readonly="readonly"/></td></tr>
          <tr><td><b>Case Register Date</b></td><td><input type="text" name="caseRegDate" value="<%=caseregisterdate %>"/><a href="javascript:show_calendar('document.register.caseRegDate', document.register.caseRegDate.value);"> <img src="images/cal.gif" alt="a" width="18" height="18" border="0"/></a></td></tr>
          <tr><td><b>Fir No</b></td><td><input type="text" name="firNo" value="<%=firno %>"/></td></tr>
          <tr><td><b>Police Station Name</b></td><td><input type="text" name="policeStationName" value="<%=policestationname %>"/></td></tr>
          <tr><td><b>Fir Date</b></td><td><input type="text" name="firDate" value="<%=firdate %>"/><a href="javascript:show_calendar('document.register.firDate', document.register.firDate.value);"> <img src="images/cal.gif" alt="a" width="18" height="18" border="0"/></a></td></tr>
          <tr><td><b>Inspector Name</b></td><td><input type="text" name="inspectorName" value="<%=inspectorname %>"/></td></tr>
          <tr><td><b>Case No</b></td><td><input type="text" name="caseno" value="<%=caseno %>"/></td></tr>
          <tr><td><b>Remand No</b></td><td><input type="text" name="remandno" value="<%=remandno %>"/></td></tr>
          <tr><td><b>Sections Covered </b></td><td><input type="text" name="sectioncovered" value="<%=sectioncovered %>"/></td></tr>
