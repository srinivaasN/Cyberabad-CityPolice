...
<span id="clock"></span>
	...
	<font color=red><b><%=request.getParameter("status") %></b></font><%} %></td></tr>
          <tr><td height="314" align="center"><br/>
           ...
           <form action="criminalmovementAction.do" method="post" name="register" onSubmit="return validate()"><fieldset>
					  <div align="center">
                    <%
                    ...
                    <br />
                      ...
                      <tr bgcolor="#0E5519"><td colspan="2" align="center"><h2><font color="#FFFF00">Registration Form</font></h2></td></tr>
                           <tr><td><b>Criminal Name</b></td><td>
                           <select name="criminalname">
         ...
         <%} %> </select></td></tr>
         <tr><td><b>Employeename</b></td><td><select name="employeename">
           <option value="--Select Any One--">--Select Any One--</option>
           ...
           Profile aproifle=(Profile)aenumeration1.nextElement();
             %><option value="<%=aproifle.getLoginID() %>"><%=aproifle.getLoginID() %></option>
             <%} %>
           </td></tr>
                        <tr>
                          <td><em><strong><strong>From Jail </strong></strong></em></td>
                          <td><input type="text" name="fromjail" class="textfield"/>                          </td>
                        </tr>
                        <tr>
                          <td><em><strong>To Jail </strong></em></td>
                          <td><input type="text" name="tojail" />
                        </td>    
                        </tr>
                        <tr>
                          <td><em><strong>Reason For Movement</strong></em></td>
                          <td><input type="text" name="reasonForMovement" class="textfield"/></td>
                        </tr>
                        <tr>
                          <td><em><strong>Criminal Expected Release Date</strong></em></td>
                          <td><input type="text" name="criminalExprelDate"/> <a href="javascript:show_calendar('document.register.criminalExprelDate', document.register.criminalExprelDate.value);"> <img src="images/cal.gif" alt="a" width="18" height="18" border="0"/></a> </td>
                        </tr>
                        <tr>
                          <td><em><strong>Criminal Actual Release Date</strong></em></td>
<td><input type="text" name="criminalActrelDate"/>   <a href="javascript:show_calendar('document.register.criminalActrelDate', document.register.criminalActrelDate.value);"> <img src="images/cal.gif" alt="a" width="18" height="18" border="0"/></a>  </td>
                        </tr>
                        <tr>
...
//You should create the validator only after the definition of the HTML form
  var frmvalidator  = new Validator("register");
     ...
     frmvalidator.addValidation("employeename","dontselect=0");
  
  frmvalidator.addValidation("fromjail","req","Please enter From Jail");
  
  
  frmvalidator.addValidation("tojail","alpha"," Last Name Alphabetic chars only");
  
   
   frmvalidator.addValidation("reasonForMovement","req","Please enter Reason  For Movement"); 
  
   frmvalidator.addValidation("criminalExprelDate","req","Please Enter Criminal ExprelDate"); 
  
   frmvalidator.addValidation("criminalActrelDate","req","Please enter Criminal ActrelDate");
    
  frmvalidator.addValidation("reasonFordelay","req","Please enter Reason Fordelay");
