...
<span id="clock"></span>
    ...
    <center><h1><font color="#FFFF00"></font></h1></center>
         <form action="employeeDutyAction.do" name="register">
         <table bgcolor="#8DD79C">
         <tr bgcolor="#0E5519">
         <td colspan="2"><h2><font color="#FFFF00">Employee Duty Master</font></h2></td></tr>
          ...
          <tr><td><b>From Time</b></td><td><input type="text" name="fromTime">
          </td></tr>
          <tr><td><b>To Time</b></td><td><input type="text" name="toTime"/></td></tr>
                     <tr><td><b>Day Of Duty</b></td><td><input type="text" name="dayOfDuty"/><a href="javascript:show_calendar('document.register.dayOfDuty', document.register.dayOfDuty.value);"> <img src="images/cal.gif" alt="a" width="18" height="18" border="0"/></a> </td></tr>
...
//You should create the validator only after the definition of the HTML form
 ...
 frmvalidator.addValidation("toTime","req","Please enter To Time");
    ...
    frmvalidator.addValidation("toTime","req","Please enter dayOfDuty");
     </script>
