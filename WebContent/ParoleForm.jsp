...
<span id="clock"></span>
	...
	<font color=red><b><%=request.getParameter("status") %></b></font><%} %></td></tr>
          <tr><td height="314" align="center"><br/>
           ...
           <form action="paroleAction.do" method="post" name="register" onSubmit="return validate()"><fieldset>
					  <div align="center">
                    <%
                    ...
                    <br />
                      ...
                      <tr bgcolor="#0E5519"><td colspan="2" align="center"><h2><font color="#FFFF00">Pay Role Registration Form</font></h2></td></tr>
         ...
         <tr><td><b>Employeename</b></td><td><select name="employeename">
           ...
           Profile aproifle=(Profile)aenumeration1.nextElement();
             ...
             <%} %>
                        ...
                        <tr>
                          <td><em><strong><strong>PayRoll Date From </strong></strong></em></td>
                          <td><input type="text" name="payroleDateFrom" class="textfield"/>  <a href="javascript:show_calendar('document.register.payroleDateFrom', document.register.payroleDateFrom.value);"> <img src="images/cal.gif" alt="a" width="18" height="18" border="0"/></a>                          </td>
                        </tr>
                        <tr>
                          <td><em><strong>PayRoll Date To</strong></em></td>
                          <td><input type="text" name="payRoleDateTo" /> <a href="javascript:show_calendar('document.register.payRoleDateTo', document.register.payRoleDateTo.value);"> <img src="images/cal.gif" alt="a" width="18" height="18" border="0"/></a> 
                        </td>    
                        </tr>
                        <tr>
                          <td><em><strong>Remarks</strong></em></td>
                          <td><input type="text" name="remarks" class="textfield"/></td>
                        </tr>
                        <tr>
                          <td><em><strong>Reason For Delay</strong></em></td>
                          <td><input type="text" name="reasonForPayrole"/></td>
                        </tr>
...
//You should create the validator only after the definition of the HTML form
  ...
  frmvalidator.addValidation("payroleDateFrom","req","Please enter Payrole DateFrom");
  
  
  
  
   
   frmvalidator.addValidation("payRoleDateTo","req","Please enter payRoleDateTo"); 
  
   frmvalidator.addValidation("remarks","req","Please Enter Remarks"); 
  
   frmvalidator.addValidation("reasonForPayrole","req","Please enter Reason For Delay");
