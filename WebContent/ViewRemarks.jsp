...
<%@page import="com.dts.core.util.CoreList"%><!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">
<html>
<head>
...
<span id="clock"></span>
    ...
    <center><h1><font color="#FFFF00">View Remarks</font></h1></center>
         
         
         <%int id=Integer.parseInt(request.getParameter("id")); 
         CriminalDutyDetailsDao adao=new CriminalDutyDetailsDao();
       String remarks=adao.ViewCriminalDuty();
                %>
                <font color="white"><h2>   <%=remarks %></h2></font>
