...
<span id="clock"></span>
    ...
    <center><h1><font color="#FFFF00">Welcome To The Employee</font></h1></center>
         ...
         <%
         String employeeregisterid=request.getParameter("employeeregisterid");
         String employeename=request.getParameter("employeename");
         
          %>
         <form action="AdminRemarkAction.jsp" method="post">
         <input type="hidden" name="employeeregisterid" value="<%=employeeregisterid %>"/>
