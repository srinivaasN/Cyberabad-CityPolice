...
<%--        <jsp:include page="Adminoptions.jsp"/>--%>
    ...
    Profile aprofile=new ProfileDAO().getProfile(loginname);
      %>
     <form action="adminUpdateProfile.do">
     <table>
     <tr>
                          <td><span class="style3"><font color="yellow"><b>Login Name</b><font color="yellow"></span></td>
                          <td><input type="text" name="loginID" value="<%=aprofile.getLoginID() %>" />                          </td>
                        </tr>
      <tr>
                          <td class="tiny style3"><font color="yellow"><b>First Name</b></font> </td>
                          <td><input type="text" name="firstname" class="textfield" value="<%=aprofile.getFirstname() %>"/>                          </td>
                        </tr>
    
    <tr>
                          <td><span class="style3"><font color="yellow"><b>Last Name </b></font></span></td>
                          <td><input type="text" name="lastname" class="textfield" value="<%=aprofile.getLastName() %>"/>                          </td>
                        </tr>
    
    
      <tr>
                          <td><span class="style3"><font color="yellow"><b>Birth Date</b></font> </span></td>
                        ...
                        <tr>
                          <td><span class="style3"><font color="yellow"><b>City</b></font></span></td>
<td><select name="city">
<option value="<%=aprofile.getCity() %>"><%=aprofile.getCity() %></option>
                        ...
                        <tr>
                          <td><span class="style3"><font color="yellow"><b>State</b></font></span></td>
<td><select name="state"><option value="<%=aprofile.getState() %>"><%=aprofile.getState() %></option>
                        ...
                        <tr>
                          <td><span class="style3"><font color="yellow"><b>Country</b></font></span></td>
