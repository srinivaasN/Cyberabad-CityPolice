...
<%--        <td>CrimnalPhoto</td>--%>
        ...
        <tr bgcolor="#8DD79C">
        <td><div align="center"><strong><a href="UpdateCriminalMaster.jsp?criminalname=<%=criminalname %>"><%=criminalname %></a></strong></div></td>
         ...
         <td><div align="center"><strong><%=expreleasedate %></strong></div></td></tr>
         <%}
         report+="</table>"; 
