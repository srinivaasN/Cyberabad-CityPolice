...
<%@page import="com.dts.ManagePrison.dao.EmployeesDutyDetailsDao"%><!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">
<html>
<head>
...
<span id="clock"></span>
    ...
    <center><h1><font color="#FFFF00">View Remarks</font></h1></center>
       ...
       String remarks=adao.ViewEmployeeDutyDetails(id);
                %>
