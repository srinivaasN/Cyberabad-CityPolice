...
public class UpdateCriminalCaseRegister extends Action
{

    public UpdateCriminalCaseRegister()
    {
    }
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
    {
        ...
        boolean flag = adao.UpdateCriminalCaseRegister(criminalCaseRegisterForm);
        if(flag)
